...
import prgrms.neoike.controller.SneakerRegisterRequest;
...
class SneakerCodeTest {
    ...
    void testInvalidSneakerCode(String code) {
        Set<ConstraintViolation<SneakerRegisterRequest>> validate = validator.validate(SneakerRegisterRequest.builder().code(code).build());
